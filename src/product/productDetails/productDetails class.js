...
class ProductDetails extends Component {
  ...
  render() {
    ...
    let counter = 1;
    const shareUrl = `http://alahee.com/productDetails/${productId}`;
                  ...
                  <div className="row">
                    <div className="col-md-12 col-lg-12">
                      ...
                      <div className="d-none d-lg-block">
                        <p style={{ color: "#931600" }} className="checkDes">
                          <i
                      ...
                      <div className="d-block d-lg-none">
                        <p style={{ color: "#931600" }} className="checkMobile">
                          <i
                            className="fa fa-check"
                            style={{
                              fontSize: "20px",
